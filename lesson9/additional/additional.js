...
//
//     block.append(id, name, username, email, addressList, phone, website, companyList);
//
//     let address = item.address;
//
//     for (let i in address) {
//         if (address[i] ==='geo') {
//             let geoList = address[i];
//             for (let y in geoList) {
//                 let geoItem = document.createElement('div');
//                 geoItem.innerText = geoList[y];
//                 geoList.appendChild(geoItem);
//             }
//         } else {
//             let addressItem = document.createElement('div');
//             addressItem.innerText = address[i];
...
//     }
    ...
    //     catchPhrase.innerText = i.catchPhrase;
